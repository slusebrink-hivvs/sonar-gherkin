...
public class GherkinLanguageTest {

  @Test
  public void getFileSuffixes() throws Exception {
    Settings curSetting = Settings.createForComponent(GherkinLanguage.class);

    GherkinLanguage lang = new GherkinLanguage(curSetting);
    String[] suff = lang.getFileSuffixes();
